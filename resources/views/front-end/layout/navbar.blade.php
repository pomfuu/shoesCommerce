<nav class="navbar navbar-expand-lg sticky-top " style="background-color: #FFFFFC">
    <div class="container-fluid p-2 align-items-center justify-content-center"
        style="margin-inline: 9vw; font-size: 1rem">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex me-2" role="search">
                <input class="form-control text-decoration-none rounded-5 me-1"
                    style="border: none; background-color: #E5E5E7" type="search" placeholder="search"
                    aria-label="Search">
